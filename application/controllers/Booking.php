...
public function exportToPdf()
	{
		...
		if($data1<1){
			$this->session->set_flashdata('pesan', '<div class="alert alert-message alert-danger" role="alert">Tidak ada Data Booking, Silahkan Lakukan Bookiing Terlebih Dahulu</div>');
