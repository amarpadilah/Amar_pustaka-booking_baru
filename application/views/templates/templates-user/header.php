...
<head>
    ...
    <link href="<?= base_url('assets/'); ?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet"type="text/css"><link href="<?=base_url('assets/');?>datatable/datatables.css"rel="stylesheet"type="text/css">
</head>
                ...
                <div class="navbar-nav">
                    ...
                    <?php
                     if (!empty($this->session->userdata('email'))) { ?>
                        ...
                        <a class="nav-item nav-link" onclick="information('Waktu Pengambilan Buku 1x24 Jam dari Booking!!!')" href="<?php echo base_url() . 'booking/exportToPdf/' . $this->session->userdata('id_user'); ?>">Cetak Bukti</a>
                        ...
                        <a class="nav-item nav-link"href="<?=base_url('member/logout');?>">
                            <i class="fas fw fa-login"></i>Logout</a>
                            ...
                            <a class="nav-item nav-link"data-toggle="modal"data-target="#daftarModal"href="#">
                                ...
                                <a class="nav-item nav-link"data-toggle="modal"data-target="#loginModal"href="#">
                                    <i class="fas fw fa-login"> </i>Login </a> 
                                    <?php } ?> 
